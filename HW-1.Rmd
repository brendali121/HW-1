...
ggplot(data=p,aes(x=carrier,y=prop,fill=region))+geom_bar(stat="identity", position="fill")+scale_fill_brewer(palette = "YlGnBu")+labs(title="Proportion of Flights that Flies to Each Region",x="Carrier",y="Proportion")
